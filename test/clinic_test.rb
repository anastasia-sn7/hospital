...
class ClinicTest < ActiveSupport::TestCase
  ...
  test "should create a new clinic" do
    assert_difference("Clinic.count") do
      post clinic_url, params: { name: "Test", address: "Testovyi", number: 111, created_at: Date.today.to_s, updated_at: Date.today.to_s }
    end
  ...
  test "should update clinic" do
    ...
    patch clinic_url(clinic), params: { name: "Test", address: "Testovyi", number: 111, created_at: Date.today.to_s, updated_at: Date.today.to_s }
