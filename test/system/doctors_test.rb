...
class DoctorsTest < ApplicationSystemTestCase
  ...
  test "should create doctor" do
    ...
    fill_in "Doctor", with: @doctor.doctor_id
    fill_in "Experience in years", with: @doctor.experience_in_years
    fill_in "Name", with: @doctor.name
    fill_in "Repartment", with: @doctor.repartment_id
    fill_in "Specialization", with: @doctor.specialization_id
