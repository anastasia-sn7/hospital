...
class SpecializationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create specialization" do
    assert_difference("Specialization.count") do
      post specializations_url, params: { specialization: { name: @specialization.name, specialization_id: @specialization.specialization_id } }
    end
  ...
  test "should update specialization" do
    patch specialization_url(@specialization), params: { specialization: { name: @specialization.name, specialization_id: @specialization.specialization_id } }
