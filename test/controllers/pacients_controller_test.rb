...
class PacientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pacient" do
    assert_difference("Pacient.count") do
      post pacients_url, params: { pacient: { age: @pacient.age, diagnosis: @pacient.diagnosis, name: @pacient.name, pacient_id: @pacient.pacient_id } }
    end
  ...
  test "should update pacient" do
    patch pacient_url(@pacient), params: { pacient: { age: @pacient.age, diagnosis: @pacient.diagnosis, name: @pacient.name, pacient_id: @pacient.pacient_id } }
